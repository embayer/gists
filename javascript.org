[...document.querySelectorAll('#sidebar-right .v-select')].forEach(element => element.classList.add('disabled'))
[...document.querySelectorAll('#sidebar-right input, select, textarea, button')].forEach(element => element.setAttribute('disabled', 'disabled'))
